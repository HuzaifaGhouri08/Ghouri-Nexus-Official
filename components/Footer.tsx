...
import { Facebook, Instagram, Linkedin, Mail, Phone, MapPin, Code, Gamepad2 } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.tiktok.com/@ghourinexus" className="text-gray-400 hover:text-cyan-400 transition-colors">
                <FaTiktok className="h-5 w-5" />
              </a>
              <a href="https://www.facebook.com/ghourinexus/" className="text-gray-400 hover:text-cyan-400 transition-colors">
                <Facebook className="h-5 w-5" />
              </a>
              <a href="https://www.instagram.com/ghourinexus/" className="text-gray-400 hover:text-cyan-400 transition-colors">
                <Instagram className="h-5 w-5" />
              </a>
              <a href="https://www.linkedin.com/in/ghourinexus/" className="text-gray-400 hover:text-cyan-400 transition-colors">
