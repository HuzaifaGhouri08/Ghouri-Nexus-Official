            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={handleChange}
                  placeholder="Portfolio-Website, LinkedIn, GitHub, etc.)"
                  className="bg-slate-700/50 border-slate-600 text-white"
                  required
                />
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">
                  Years Experience and Company *
                </label>
                <Textarea
                  name="experience"
                  value={form.experience}
                  onChange={handleChange}
                  placeholder="2+ years as a backend developer at XYZ company"
                  className="bg-slate-700/50 border-slate-600 text-white"
                  required
                  rows={3}
                />
              ...
              <div>
                ...
                <Textarea
                  ...
                  value={form.anything}
                  onChange={handleChange}
                  placeholder="Looking for a role as a frontend developer at Ghouri Nexus"
                  className="bg-slate-700/50 border-slate-600 text-white"
                  required
                  rows={3}
                />
