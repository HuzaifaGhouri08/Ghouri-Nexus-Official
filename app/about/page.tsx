          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-400 mb-6 text-lg leading-relaxed">
                Ghouri Nexus was founded in 2023 by Huzaifa Ghouri with a clear mission: to dismantle the complex barriers facing new entrepreneurs. Huzaifa Ghouri, as Founder, recognized that while many people dream of starting a business, they are often paralyzed by the technical and marketing requirements—from setting up a proper store to mastering paid advertising. We stepped in to create an all-in-one solution that takes the guesswork out of the launch process, allowing creators to focus solely on their product while we handle the entire digital build and growth strategy.
              </p>
              <p className="text-gray-400 mb-8 text-lg leading-relaxed">
                Our signature offering, The Ghouri Nexus Launchpad, is designed to be the complete, hands-off solution for e-commerce success. We don't just build websites; we create fully optimized businesses. This means setting up your high-converting Shopify Store, generating hyper-realistic AI cinematic product photos and videos, and developing comprehensive, profitable strategies across Social Media Marketing and Meta Ads. We leverage the precision of professional software development and the creativity of innovative design to build digital experiences that are engineered to sell.
              </p>
               <p className="text-gray-400 mb-8 text-lg leading-relaxed">
                The confidence in our expertise is backed by a powerful commitment: The First Sale Guarantee. At Ghouri Nexus, we ensure our clients' success by committing our time, resources, and strategies until you achieve your first validated sale. For every entrepreneur who feels lost at the starting line, Huzaifa Ghouri and the Ghouri Nexus team provide the guidance, the tools, and the guarantee you need to transform your product idea into proven income.
                </p>
            ...
            <div className="relative">
              ...
              <Card className="relative bg-slate-800/50 border-slate-700">
                <CardContent className="cursor-grab p-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <Card key={index} className="cursor-move bg-slate-800/50 border-slate-700 hover:border-cyan-500/50 transition-all duration-300 card-glow group overflow-hidden">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="cursor-grab bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border-cyan-500/30 card-glow">
            ...
            <Card className="cursor-grab bg-gradient-to-br from-purple-500/10 to-pink-500/10 border-purple-500/30 card-glow">
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
